 ...
 *
 * <p>
 *  <code> Runnable </code>接口应该由任何类实现,其实例旨在由Thread执行。该类必须定义一个没有参数<code> run </code>的方法。
 * <p>
 *  此接口旨在为希望在激活时执行代码的对象提供一个通用协议。例如,<code> Runnable </code>由类<code> Thread </code>实现。
...
public interface Runnable {
     ...
     *
     * 当一个对象实现Runnable被用于创建一个线程时，启动这个线程时会导致这个run方法被调用，在一个单独线程中
     * <p>
     *
     * 
